	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (v2f_customrendertexture i) : SV_Target
			{
				...
				half4 col = tex2D(_MainTex, uv * float2(1.0, 0.5) + float2(0.0, 0.5));
				col.a = lerp(_DepthTop, _DepthBottom, tex2D(_MainTex, uv * float2(1.0, 0.5)).r);
